...
namespace FELFactura
{
    ...
    {
        public static async Task<String> envioSolitudAsync(String xml)
        {
            String res = "";
            using (var client = new HttpClient())
            {
               ...
               // solictud.archivo = xml;
                ...
                .ContinueWith(async responseTask =>
                {
                    ...
                    //respuestaSolitud = JsonConvert.DeserializeObject<RespuestaSolitud>(json);
                    //  Console.WriteLine("\n{0}", respuestaSolitud.archivo);
        ...
        private static async Task certificacion(String xml)
        {
